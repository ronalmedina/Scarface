    ...
    <main class="pedidos">
        ...
        <section class="banner">
            ...
            <div class="container">
                ...
                <img style="width: 75%;position: relative;display: flex;margin: 0 auto;top: 12vh;" src="../../views/client/img/banner/pedidos.jpg" alt="">
            
            </div>

        </section>

        <h2 class="Pedido" style="position: relative;display: flex;margin: 0 auto;justify-content: center;top: 10vh;">Mis pedidos</h2>
        <p class="Ver" style="position: relative;display: flex;justify-content: center;top: 14vh;">Puedes ver tus pedidos</p>

        <div class="container">

        <table class="table" style="position: relative;top: 20vh;">
            <thead>
                <tr>
                <th class="columna" scope="col">Pedido -ID-</th>
                <th class="columna" scope="col">Fecha</th>
                <th class="columna" scope="col">Estado</th>
                <th class="columna" scope="col">Generar Factura</th>
                <th class="columna" scope="col">Eliminar pedido</th>
                </tr>
            </thead>
