...
require_once("../../Controller/Admin/Arrgl_Editarproducto.php");
?>
              ...
              <div class="row">
                ...
                <div class="card mb-4">
                  <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <small class="text-muted float-end">Ingrese toda la información necesaria para editar este producto</small>
                  </div>
                  <div class="card-body">
                    <?php
                        editar_Producto();
